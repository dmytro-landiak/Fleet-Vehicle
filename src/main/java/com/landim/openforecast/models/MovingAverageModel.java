 ...
 * For examples, many charts of individual stocks on the stock market show 20,
 ...
 * examples, if a data series has a noticable upward trend then a moving average
...
public class MovingAverageModel extends WeightedMovingAverageModel
{
     ...
     * be used to calculate the moving average. For examples, for a 50-day
